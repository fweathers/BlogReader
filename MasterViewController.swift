...
//  BlogReader
//
//  Created by Felicia Weathers on 10/31/16.
...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyDY7h96pJx4dXsaGNiqSb70TLRcY6ySewg")!
                    ...
                    do {
                        ...
                        if let items = jsonResult["items"] as? NSArray {
                            ...
                            for item in items {
                                ...
                                newEvent.setValue(item["published"] as! String, forKey: "publishedDate")
